...
<div class="form-card">
    <div class="form-card-header">
        <h4><i class="fas fa-plus-circle me-2"></i> Tambah Alat Musik</h4>
        <p>Isi data inventaris baru di bawah ini</p>
    </div>
    <div class="form-card-body">
        <form action="<?= BASEURL; ?>/AdminController/tambah_alat" method="post">
            <div class="mb-4">
                <label class="form-label">Nama Alat Musik</label>
                <input type="text" name="nama_alat" class="form-control" placeholder="Contoh: Gitar Akustik" required>
            </div>
            <div class="row g-3 mb-4">
                <div class="col-6">
                    <label class="form-label">Jumlah Stok</label>
                    <div class="input-group">
                        <input type="number" name="stok" class="form-control" placeholder="0" min="0" required style="border-radius:10px 0 0 10px;">
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn-submit"><i class="fas fa-save me-2"></i>Simpan ke Inventaris</button>
